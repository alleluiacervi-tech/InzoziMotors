...
const styles = StyleSheet.create({
  ...
  heroText: { marginTop: 7, fontSize: 13.5, lineHeight: 20, color: colors.textSecondary },
  ...
  stepTitle: { fontSize: 14.5, fontFamily: fonts.extraBold, color: colors.textPrimary },
  stepText: { marginTop: 6, fontSize: 12.5, lineHeight: 19, color: colors.textSecondary },
  ...
  boundaryText: { marginTop: 6, fontSize: 12.5, lineHeight: 19, color: colors.textSecondary },
