...
const styles = StyleSheet.create({
  ...
  noticeText: { marginTop: 5, fontSize: 13, lineHeight: 19, fontFamily: fonts.regular, color: colors.textSecondary },
  ...
  submit: { marginTop: 14 },
  privacy: { marginTop: 12, textAlign: 'center', fontSize: 12, lineHeight: 17, fontFamily: fonts.regular, color: colors.textMuted },
