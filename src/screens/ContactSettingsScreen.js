...
const styles = StyleSheet.create({
  content: { padding: 20, paddingTop: 8, paddingBottom: 40 }, intro: { marginBottom: 20, fontSize: 13, lineHeight: 20, color: colors.textSecondary }, locked: { flexDirection: 'row', alignItems: 'flex-start', gap: 11, marginBottom: 18, borderRadius: radius.xl, backgroundColor: '#FFF8E8', padding: 15 }, lockedTitle: { fontSize: 14, fontFamily: fonts.extraBold, color: colors.textPrimary }, lockedText: { marginTop: 4, fontSize: 13, lineHeight: 18, color: colors.textSecondary },
