...
const styles = StyleSheet.create({
  content: { padding: 20, paddingTop: 8, paddingBottom: 40 }, intro: { marginBottom: 20, fontSize: 13.5, lineHeight: 20, color: colors.textSecondary }, locked: { flexDirection: 'row', alignItems: 'flex-start', gap: 11, marginBottom: 18, borderRadius: radius.xl, backgroundColor: '#FFF8E8', padding: 15 }, lockedTitle: { fontSize: 14, fontFamily: fonts.extraBold, color: colors.textPrimary }, lockedText: { marginTop: 4, fontSize: 12.5, lineHeight: 18, color: colors.textSecondary },
  ...
  visibility: { minHeight: 76, flexDirection: 'row', alignItems: 'center', gap: 12, marginBottom: 10, borderWidth: 1, borderColor: colors.borderSoft, borderRadius: radius.xl, backgroundColor: colors.surface, padding: 14 }, disabled: { opacity: 0.5 }, visibilityIcon: { width: 40, height: 40, borderRadius: 13, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.blueTint }, visibilityTitle: { fontSize: 14, fontFamily: fonts.extraBold, color: colors.textPrimary }, visibilityText: { marginTop: 3, fontSize: 11.5, lineHeight: 16, color: colors.textMuted }, switch: { width: 48, height: 28, borderRadius: 14, justifyContent: 'center', padding: 3, backgroundColor: colors.border }, switchOn: { backgroundColor: colors.primary }, knob: { width: 22, height: 22, borderRadius: 11, backgroundColor: '#fff' }, knobOn: { alignSelf: 'flex-end' },
