...
const HOW_IT_WORKS = [
  { icon: 'share-outline', step: '1', title: 'Share your code', desc: 'Send your unique referral code to friends who want to sell their car on Sawa Cars.' },
...
export default function ReferralScreen({ navigation }) {
  ...
  const handleShare = async () => {
    ...
    try {
      await Share.share({
        message: `I use Sawa Cars to sell cars in Kigali — certified, inspected, trusted. Sign up with my code ${referralCode} when you submit your car and we both save on fees. https://sawacars.com/ref/${referralCode}`,
        title: 'Join Sawa Cars',
      });
    } catch (e) {
