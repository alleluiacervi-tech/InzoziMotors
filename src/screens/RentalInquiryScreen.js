...
const styles = StyleSheet.create({
  ...
  section: { marginTop: 22, fontSize: 16, fontFamily: fonts.extraBold, color: colors.textPrimary }, helper: { marginTop: 5, marginBottom: 12, fontSize: 12.5, lineHeight: 18, color: colors.textMuted },
  ...
  notice: { flexDirection: 'row', alignItems: 'flex-start', gap: 10, marginVertical: 20, padding: 15, borderRadius: radius.xl, backgroundColor: colors.blueTint }, noticeText: { flex: 1, fontSize: 12.5, lineHeight: 19, color: colors.textSecondary },
  ...
  center: { flex: 1, alignItems: 'center', justifyContent: 'center' }, success: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 28 }, successIcon: { width: 68, height: 68, borderRadius: 34, backgroundColor: colors.green, alignItems: 'center', justifyContent: 'center' }, successTitle: { marginTop: 20, fontSize: 22, fontFamily: fonts.extraBold, color: colors.textPrimary, textAlign: 'center' }, successBody: { marginTop: 10, fontSize: 14, lineHeight: 21, color: colors.textSecondary, textAlign: 'center' }, successButton: { marginTop: 14 }, noticeSmall: { marginTop: 18, fontSize: 11.5, lineHeight: 17, color: colors.textMuted, textAlign: 'center' },
});
