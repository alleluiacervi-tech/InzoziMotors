...
const styles = StyleSheet.create({
  ...
  heroText: { marginTop: 8, fontSize: 13.5, lineHeight: 20, color: colors.textSecondary, textAlign: 'center' },
  ...
  cardTitle: { fontSize: 14.5, fontFamily: fonts.extraBold, color: colors.textPrimary },
  cardText: { marginTop: 4, fontSize: 12.5, lineHeight: 18, color: colors.textSecondary },
  ...
  directText: { marginTop: 6, fontSize: 12.5, lineHeight: 19, color: 'rgba(255,255,255,0.82)' },
  ...
  noGuaranteeText: { flex: 1, fontSize: 12.5, lineHeight: 19, color: colors.textSecondary },
});
