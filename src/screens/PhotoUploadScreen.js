...
const styles = StyleSheet.create({
  ...
  score: { marginTop: 4, fontSize: 12.5, color: colors.textSecondary },
  ...
  countLabel: { fontSize: 10.5, color: colors.textMuted },
  ...
  infoText: { marginTop: 4, fontSize: 12.5, lineHeight: 18, color: colors.textSecondary },
  ...
  addText: { marginTop: 2, fontSize: 10.5, color: colors.textMuted },
  ...
  tipText: { flex: 1, fontSize: 12.5, lineHeight: 18, color: colors.textSecondary },
