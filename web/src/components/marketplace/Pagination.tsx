      ...
      <div className="flex items-center gap-2">
        {hasPrevious ? (
          <Link
            ...
            rel="prev"
            className="inline-flex h-11 items-center gap-1.5 rounded-xl border border-line bg-surface px-4 text-sm font-bold text-content transition-colors hover:border-content-muted hover:bg-surface-alt"
          >
            <Icon name="chevron-left" size={16} className="text-content-secondary" />
            Previous
          </Link>
        ) : (
          <span className="inline-flex h-11 items-center gap-1.5 rounded-xl border border-line-soft px-4 text-sm font-bold text-content-muted">
