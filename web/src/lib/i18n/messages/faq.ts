...
export const faq: Record<Locale, Record<string, unknown>> = {
  ...
  zh: {
    pay: {
      q: '我通过应用或网站支付任何费用吗？',
      a: '不需要。Sawa Cars 没有用于车辆买卖或租赁的结账或支付通道。买家、卖家和租赁提供方直接自行决定付款与合同安排，并应仔细将其记录在案。',
    },
    inspection: {
      q: '150项检测究竟包括哪些内容？',
    ...
    guarantee: {
      ...
      a: '不提供。Sawa Cars 审核车源信息及卖家资格，但不对用户之间的车辆、付款、租赁押金、合同、交付或结果提供担保。请务必进行检测、核实，并以书面形式约定条款。',
    },
    listing: {
      q: '卖家可以自行发布车辆吗？',
      a: '卖家提交车辆信息，并可以管理已获批准的车源详情，但只有获授权的管理员才能在完成所需审核后将车源公开发布。',
    },
    cost: {
      q: '出售车辆需要支付什么费用？',
      a: '任何商业服务或发布费用均由 Sawa Cars 单独告知，且不通过买卖双方之间的支付通道收取。车辆交易本身始终发生在用户之间。',
    },
    reserve: {
      q: '联系卖家是否会预留车辆？',
      a: '不会。联系卖家只是开启一段沟通。在您与卖家达成自己的约定之前，车辆是否仍可购买始终由卖家自行负责。',
    },
    appOrWeb: {
      q: '我需要使用手机应用吗，还是可以在网页上完成所有操作？',
      a: '浏览车辆、检测信息、收藏车辆、直接联系卖家以及您的账户功能均可在网页上使用。应用额外提供拍照、推送通知以及更便捷的消息体验。',
    },
    areas: {
      q: '你们的服务覆盖哪些区域？',
      a: '我们在基加利全境提供检测服务。车源会显示每辆车提供的所在位置。买卖双方自行决定在哪里查看或交接车辆。',
    },
  },
}
