...
export const home: Record<Locale, Record<string, unknown>> = {
  en: {
    ...
    front: {
      ...
      importLede: 'Have a car in mind from Japan, Korea or China? See what it costs landed in Kigali, duty included, before you commit.',
      importYear: 'Year',
      ...
      ways: {
        ...
        importTitle: 'Import from Japan, Korea or China',
  ...
  rw: {
    ...
    front: {
      ...
      importLede: 'Hari imodoka wifuza yo mu Buyapani, Koreya cyangwa Ubushinwa? Reba igiciro cyayo igeze i Kigali, harimo n’imisoro, mbere yo kwiyemeza.',
      importYear: 'Umwaka',
      ...
      ways: {
        ...
        importTitle: 'Tumiza mu Buyapani, Koreya cyangwa Ubushinwa',
  ...
  fr: {
    ...
    front: {
      ...
      importLede: 'Une voiture en vue au Japon, en Corée ou en Chine ? Voyez son coût rendu à Kigali, droits compris, avant de vous engager.',
      importYear: 'Année',
      ...
      ways: {
        ...
        importTitle: 'Importer du Japon, de Corée ou de Chine',
  ...
  sw: {
    ...
    front: {
      ...
      importLede: 'Una gari akilini kutoka Japani, Korea au China? Ona gharama yake likifika Kigali, pamoja na ushuru, kabla ya kujitolea.',
      importYear: 'Mwaka',
      ...
      ways: {
        ...
        importTitle: 'Agiza kutoka Japani, Korea au China',
  ...
  ko: {
    ...
    front: {
      ...
      rentCta: '렌트 차량 보기',
      importLede: '일본, 한국, 중국에서 원하는 차가 있나요? 계약 전에 관세 포함 키갈리 도착 비용을 확인하세요.',
      importYear: '연식',
  ...
  zh: {
    ...
    front: {
      ...
      rentCta: '查看租赁车辆',
      importLede: '看中了日本、韩国或中国的车？在决定前，先看看含关税运抵基加利的总成本。',
      importYear: '年份',
      importPrice: '海外价格（美元）',
      importCta: '估算到岸成本',
      cert: {
