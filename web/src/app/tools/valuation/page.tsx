...
export const metadata: Metadata = {
  ...
  description:
    'What is your car worth in Kigali today? A free market valuation priced from cars actually listed and sold on Inzozi Motors — never a lookup table. No account needed.',
  alternates: { canonical: '/tools/valuation' },
  openGraph: {
    title: 'Free car valuation — Inzozi Motors',
    url: '/tools/valuation',
  ...
  return (
    <>
      <PageHeader
        ...
        lede="Priced from cars actually listed and sold on Inzozi — never a lookup table. Where we do not have enough comparable cars to be sure, we say so instead of inventing a figure."
      />
      <Section tone="page">
        <Container>
