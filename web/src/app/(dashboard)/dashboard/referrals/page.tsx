...
export default async function ReferralsPage() {
  ...
  const shareText = referral
    ? `I sell and buy cars on Inzozi Motors — every car passes a 150-point inspection before it is listed. Use my code ${referral.code} when you sell yours and you get a discount on the seller commission. ${SITE.url}`
    : ''
  ...
  return (
    <>
      <PageHeader
        title="Referrals"
        description="Share Inzozi with someone selling a car. When they redeem your code, they get a discount on the commission for their first completed sale."
      />
