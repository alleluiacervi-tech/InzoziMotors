...
//
// Server-rendered from the URL, every time. No client-side data fetching, no
// "loading spinner then content": a crawler and a buyer on a slow Kigali
// connection both get the same finished HTML, and every filtered view is a real
  ...
  return (
    <Container className="py-8 sm:py-12">
      <header className="max-w-2xl">
        <p className="text-eyebrow font-bold uppercase text-brand">The marketplace</p>
        <h1 className="mt-3 text-headline font-extrabold text-content">{heading}</h1>
        <p className="mt-4 text-[17px] leading-relaxed text-content-secondary">
          Only the Inzozi team publishes listings, and only after the car has been
          inspected and photographed at one of our centers. Browsing is free, and
          buyers never pay us a fee.
        </p>
      </header>
      ...
      <div className="mt-10 grid gap-10 lg:grid-cols-[264px_minmax(0,1fr)] lg:gap-12">
        <aside className="hidden lg:block">
          <div className="sticky top-[calc(var(--header-h)+24px)]">
            <h2 className="mb-5 text-[13px] font-bold uppercase tracking-wide text-content-muted">
              Narrow it down
            </h2>
            ...
            <EmptyState
              ...
              description={
                offset > 0
                  ...
                  : 'Our inventory changes as cars clear inspection. Widen the search, or save the search in the app and we will tell you the day a match goes live.'
              }
              action={
